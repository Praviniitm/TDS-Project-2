...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Analyze a dataset and generate visualizations and a markdown report.")
    parser.add_argument("input_file", help="Path to the input dataset file (e.g., dataset.csv)")
    args = parser.parse_args()

    run_analysis(args.input_file)